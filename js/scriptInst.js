...
{
  gltfLoader.load(    
    'assets/Walls/wall111.glb',
    (gltf) =>
    {      
      instancedWall1 = new THREE.InstancedMesh(gltf.scenes[0].children[0].geometry, gltf.scenes[0].children[0].material, 400);      
      scene.add(instancedWall1);        
      CreatePostInstance(); 
    });
  gltfLoader.load(    
    'assets/Walls/wall222.glb',
    (gltf) =>
    {      
      instancedWall2 = new THREE.InstancedMesh(gltf.scenes[0].children[0].geometry, gltf.scenes[0].children[0].material, 400);      
      scene.add(instancedWall2);       
    });
  gltfLoader.load(    
    'assets/Walls/wall333.glb',
    (gltf) =>
    {      
      instancedWall3 = new THREE.InstancedMesh(gltf.scenes[0].children[0].geometry, gltf.scenes[0].children[0].material, 400);      
      scene.add(instancedWall3);     
    });
  gltfLoader.load(    
    'assets/Walls/wall444.glb',
    (gltf) =>
    {      
      instancedWall4 = new THREE.InstancedMesh(gltf.scenes[0].children[0].geometry, gltf.scenes[0].children[0].material, 400);      
      scene.add(instancedWall4);     
    });
}

function AddWallInstance(xPos,zPos)
{
    dummyWallObj.position.set((xPos*10)+5, 0, (zPos*10)*-1); 
    dummyWallObj.position.y = 0;
    dummyWallObj.rotation.x = Math.PI / 2;
    dummyWallObj.rotation.z = Math.PI / 2;
  ...
  {    
    case 0:
      instancedWall1.setMatrixAt((xPos*(mWidth))+zPos, dummyWallObj.matrix);    
    break;
