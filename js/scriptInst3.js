...
/*
const bgTexture2 = textureLoader.load('assets/duskBack.fw.png');
*/
const duskTexture = textureLoader.load('assets/duskBack2.fw.png');

/*
const nightTexture = textureLoader.load('assets/night.fw.png');
const night1Texture = textureLoader.load('assets/night1.fw.png');
const night2Texture = textureLoader.load('assets/night2.fw.png');
*/
...
const playerBase = textureLoader.load('assets/Skele/base_skeleton.png');
...
var dayWind = new Howl({  
  src:['assets/Audio/windLoop2.ogg'],
  volume: .1,
  loop: true,   
}); 

var crickets = new Howl({  
  src:['assets/Audio/cricketLoop.ogg'],
  volume: .1,
  loop: true,   
}); 

var chimes = new Howl({  
  src:['assets/Audio/chimeLoop.ogg'],
  volume: .1,
  loop: true,   
}); 
    ...
    (gltf) =>
    {
      ...
      const c4 = new CANNON.Body({
        ...
        world.addBody(c4); 
          ...
          /*
        const rewardLight = new THREE.PointLight( 0xffffff,1,20);
        rewardLight.position.set(newObj.position.x,newObj.position.y+10,newObj.position.z);
...
document.addEventListener('keydown', function(e){
  ...
  {
    //UnCancelTraps();
    scene.background =night1Texture;
  }  
});
document.addEventListener('keydown', function(e){
  if(e.key === '6')
  {
    //UnCancelTraps();
    scene.background =night2Texture;
  }  
});
document.addEventListener('keydown', function(e){
  if(e.key === '7')
