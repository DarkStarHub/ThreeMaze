...
const startEnv = Math.floor((Math.random() * 3));
...
var dayWind = new Howl({  
  src:['assets/Audio/windLoop.mp3'],
  volume: .1,
  loop: true,   
}); 

var crickets = new Howl({  
  src:['assets/Audio/cricketLoop.mp3'],
  volume: .1,
  loop: true,   
}); 

var chimes = new Howl({  
  src:['assets/Audio/chimeLoop.mp3'],
  volume: .1,
  loop: true,   
}); 
...
var portalSound = new Howl({  
  src:['assets/Audio/portalLoop.mp3'],
  loop: true,  
}); 
...
var trapSound = new Howl({  
  src:['assets/Audio/trapSound.mp3'],
  //html5: true
}); 
...
function TrapSoundSpatial(x,z) {   
  ...
  trapSound.pannerAttr(id).rolloffFactor= 1.2;  
